...
public class GuiSecStorage extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		//mc.renderEngine.bindTexture("/mods/mffs/textures/gui/GuiSecStorage.png");
		mc.renderEngine.func_110577_a(new ResourceLocation("mffs:textures/gui/GuiSecStorage.png"));
		int w = (width - xSize) / 2;
