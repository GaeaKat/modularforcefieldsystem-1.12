...
public class MFFSBlockRenderer extends TileEntitySpecialRenderer<TileEntityForceField> {
	...
	@Override
	public void renderTileEntityAt(TileEntityForceField te, double x, double y, double z, float partialTicks, int destroyStage) {
		if(getWorld().getBlockState(new BlockPos(x,y,z)).getBlock()==ModularForceFieldSystem.MFFSFieldblock) {
