 ...
 */
public class MFFSOreGen implements IWorldGenerator {

    private WorldGenerator gen_monazit_ore;


    public MFFSOreGen() {
        this.gen_monazit_ore = new WorldGenMinable(MFFSBlocks.monazit_ore.getDefaultState(),8);
    }
